    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BusTrips_Routes_RoutesId",
                        column: x => x.RoutesId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BusTripImageId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusTripImages", x => x.BusTripImageId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stops_BusTrips_BusTripId",
                        column: x => x.BusTripId,
                        principalTable: "BusTrips",
                        principalColumn: "BusTripId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusTrips_RoutesId",
                table: "BusTrips",
                column: "RoutesId");

            migrationBuilder.CreateIndex(
                name: "IX_Stops_BusTripId",
                table: "Stops",
                column: "BusTripId");
        }
